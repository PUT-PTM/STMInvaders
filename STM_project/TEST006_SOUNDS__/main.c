...
extern unsigned char _binary_out_bin_start;
extern unsigned char _binary_out_bin_end;
extern unsigned char _binary_out_bin_size;

int main(void)
{
	SystemInit();

	unsigned char kupa = _binary_out_bin_start;
    ...
    while(1)
    {
    	...
    	if (SPI_I2S_GetFlagStatus(CODEC_I2S, SPI_I2S_FLAG_TXE))
    	{
    		...
    		//SPI_I2S_SendData(CODEC_I2S, dupa);
